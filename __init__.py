...
class TurnOnLight(OVOSSkill):
    ...
    def initialize(self):
        ...
        self.add_event("turn.on.light.one", self.handle_turn_on_light_intent)
        self.my_var = "turn on light one"
    ...
    def handle_turn_on_light_intent(self, message):
        ...
        self.speak("Light one turned on")
